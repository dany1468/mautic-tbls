...
| ---- | ---- | ------- | -------- | --------------- | -------- | ------- | ------- |
| id | int(10) unsigned |  | false | auto_increment | [message_channels](message_channels.md) |  |  |
...
| ---- | ---- | ---------- |
| FK_DB021E9612469DE2 | FOREIGN KEY | FOREIGN KEY (category_id) REFERENCES categories (id) |
...
| Name | Definition |
| ---- | ---------- |
| date_message_added | KEY date_message_added (date_added) USING BTREE |
| IDX_DB021E9612469DE2 | KEY IDX_DB021E9612469DE2 (category_id) USING BTREE |
